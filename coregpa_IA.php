...
<?php 
 ...
 $sql = "select c.classname, g.gradeletter from class c JOIN user u JOIN grade g where c.classid = g.classid And u.userid = g.userid AND g.classid IN ('6363','6324','6359') AND u.username= '".$_SESSION['sess_user']."' ";      
...
if($array['classname'] == 'Information Security' ||  $array['classname'] == 'Design and Analysis of Computer Algorithms' || $array['classname']== '' || $array['classname']== '' || $array['classname']== '')
					{
						$totalGrade1 = ($totalGrade1 + $numberGrade);
                           $avggrade1 = ($totalGrade1)/2; 
					}
