...
<h3 id = "text">Manage User</h3><br/>
<h3 id = "text1"><a href="usermgmt.php">Go Back!</a></h3><br/>
<form action="#" method="POST" id= "ManageUser_Form" name= "Registration_Form" onsubmit="return chkRegForm() && passcheck();">
...
<input type="submit" value="Add User" id = "Register_Button" name="submit" /><br /><br />
<input type="submit" value="Update User" id = "Register_Button" name="update_user" /><div id = "update_user"><?php include "update_user.php"; ?></div><br />
<input type="submit" value="Delete User" id = "Register_Button" name="delete_user" /><?php include "delete_user.php" ; ?><br /><br />
</form>
</div>
