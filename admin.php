...
<a href = "#" class = "tooltip" title= "UT Dallas Degree Planner" ><img src = "images/utd-logo.png" alt = "UT Dallas Degree Planner"></a>
 ...
 <div class = "navigation">
   <nav>
   <ul>
	     <li><a href = "http://localhost/www21/index.php" class = "tooltip" title= "Go Back" >Go Back!</a></li>
...
<div class = "main">
  ...
  <div class = "login"><br/>
    <div id = "text">Administration Login</div>
		...
		<form  name = "Login_Form" id = "Login_Form" onsubmit="return validateForm();"  method="post" action = "">
			...
			<input id = "submit" type = "submit" name = "admin" value = "Admin"  ></a><br/><br/>
			<div class = "register">First Time Admin? <a href= "http://localhost/www21/register_admin.php" id = "register" target= "_blank">Register</a><br/><br/>
