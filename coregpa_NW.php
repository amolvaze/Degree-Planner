...
<?php 
 ...
 $sql = "select c.classname, g.gradeletter from class c JOIN user u JOIN grade g where c.classid = g.classid And u.userid = g.userid AND g.classid IN ('6396','6378','6359','6390','6352') AND u.username= '".$_SESSION['sess_user']."' ";      
...
if($array['classname'] == 'Performance Of Computer Systems & Networks' ||  $array['classname'] == 'Design and Analysis of Computer Algorithms' || $array['classname']== 'Advanced Computer Networks' || $array['classname']== 'Advanced Operating Systems' || $array['classname']== '')
					{
						$totalGrade1 = ($totalGrade1 + $numberGrade);
                           $avggrade1 = ($totalGrade1)/3.0; 
					}
