...
<?php 
	...
	$sql = "select sum(c.classhours) As classhours from class c JOIN grade g JOIN user u where u.userid = g.userid AND c.classid=g.classid AND g.classid IN ('6363','6324', '6359')AND u.username= '".$_SESSION['sess_user']."'  " ;		
