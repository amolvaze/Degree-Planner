   ...
   <nav>
    <ul>
	     <!--<li><a href = "http://localhost/www21/index.php" class = "tooltip" title= "Home" >Home</a></li>-->
		  ...
		  <li><a href = "http://localhost/www21/Traditional.php" class= "tooltip" title= "Go Back">Go Back!</a></li>
...
<?php 
 ...
 //$sql = "select * from class c JOIN user u JOIN grade g where c.classid = g.classid And u.userid = g.userid AND u.username= '".$_SESSION['sess_user']."' ";
  $sql = "select c.classid, c.classname, c.grade, g.gradeletter from class c JOIN grade g JOIN user u where g.classid= c.classid And u.userid = g.userid AND g.classid IN ('6363', '6378', '6390', '6360' , '6359', '6322', '6384'  ) AND u.username= '".$_SESSION['sess_user']."'";			
...
<center><strong>Grade(GPA) Analysis Of Traditional Track</strong></center><br/><br/>
<center><strong><div id = "credit"><?php //include "credithrs_TR.php"; ?></div></strong></center><br/><br/>
<center><strong><div id = "prereq"><?php //include("classes-req_TR.php") ?></div></strong></center><br/>
<center><strong><div id = "transwaved"><?php //include("transwaved_TR.php") ?></div></strong></center><br/>
<center><strong>Core & Overall GPA Of <?=$_SESSION['sess_user'];?> are:- <div id = "result"><?php //include "coregpa_TR.php"; ?></div></strong></center>
</div>
<!-- <center><strong>Overall GPA Of <?=$_SESSION['sess_user'];?> is:- <div id = "result1"><?php //include "gpa.php"; ?></div></strong></center>-->

 <div class = "footer"> 
   <footer><!-- <a href="http://localhost/www21/index.php">Home</a><a href="http://localhost/www21/degree-plan.php">Degree Plan</a> |-->	 <a href="http://localhost/www21/Traditional.php">Go Back</a> <!--| <a href="http://localhost/www21/courses.php">Courses</a>--> <br/><br/>
