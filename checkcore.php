...
<?php
	     ...
	     //case "Data Science"
     $sql="select count(classid) AS core from class where classid IN ('6301', '6313', '6363', '6360', '6375')";
						...
						if ($result=mysqli_query($con,$sql))
						  ...
						  while ($array=mysqli_fetch_array($result))
							...
							print("You have completed Data Science core courses! ");
							 }
							 else {
							 print("Yet to finish core courses.");
							 echo "<br/>";
							 print("You must take at least 2 core courses. Register now!");
							 }
