...
<a href = "#" class = "tooltip" title= "UT Dallas Degree Planner" ><img src = "images/utd-logo.png" alt = "UT Dallas Degree Planner"></a>
 ...
 <div class = "navigation">
   <nav>
     <ul><li><a href = "http://localhost/www21/login.php" class= "tooltip" title= "USE" >Go Back! </a></li></ul>
   </nav> 
</div><br/><br/>
<div class = "main">

  <div class = "login"><br/>
    <div id = "USE">USE Form</div>
    <div id= "USE_Form">
	...
	<center><input type = "submit" name= "survey_button" id= "survey_button" value = "Submit" onclick="alert('Data Submitted');" ></center>	
 </form>
		<div id="msg"></div>
 ...
 <input type = "button" id = "maildata" name= "maildata"  value = "Mail Data" > <input type = "button" id = "commentall" name= "commentall"  value = "Comment All" ><br/><br/>-->
    ...
    <div class = "footer"> 
   <footer><a href = "http://localhost/www21/login.php" class= "tooltip" title= "USE" >Go Back! </a><br/><br/><!-- <a href="#">Home</a> | <a href="http://localhost/www21/degree-plan.php">Degree Plan</a> | <a href="http://localhost/www21/degree-req.php">Degree Requirements</a>| <a href="http://localhost/www21/courses.php">Courses</a><br/><br/>-->
