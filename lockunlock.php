...
<a href = "#" class = "tooltip" title= "UT Dallas Degree Planner" ><img src = "images/utd-logo.png" alt = "UT Dallas Degree Planner"></a>
 ...
 <div class = "navigation">
   <nav>
   <ul><li><a href = "http://localhost/www21/usermgmt.php" class = "tooltip" title= "Go Back! " >Go Back! </a></li></ul>
   <!-- <ul>
...
<div class = "main">
  ...
  <div class = "login"><br/>
    <div id = "text">Lock Management</div>
   ...
   <!--<a href= "http://localhost/www21/admin.php" id = "admin" target= "_blank">Admin Login</a><br/><br/>-->
			...
			if(isset($_POST["submit"])){
					...
					if(!empty($_POST['Username']) && !empty($_POST['Password'])) {
						...
						echo "<script type='text/javascript'>alert('Try again!')</script>";
							 ...
							 echo "<script type='text/javascript'>alert('Password has been locked!')</script>";
    ...
    <div class = "footer"> 
   <footer><a href="http://localhost/www21/usermgmt.php">Go Back</a><br/><br/> <!-- | <a href="http://localhost/www21/degree-plan.php">Degree Plan</a> | <a href="http://localhost/www21/degree-req.php">Degree Requirements</a>| <a href="http://localhost/www21/courses.php">Courses</a><br/><br/>-->
