   ...
   <nav>
    <ul>
	     <!--<li><a href = "http://localhost/www21/index.php" class = "tooltip" title= "Home" >Home</a></li>-->
		  ...
		  <li><a href = "http://localhost/www21/degree-plan.php" class= "tooltip" title= "Go Back">Go Back!</a></li>
...
<center><strong>Grade(GPA) Analysis Of Data Science Track</strong></center><br/><br/>
<center><strong><div id = "credit"><?php include "credithrs.php"; ?></div></strong></center><br/><br/>
<center><strong><div id = "prereq"><?php include("classes-req.php") ?></div></strong></center><br/>
<center><strong><div id = "transwaved"><?php include("transwaved.php") ?></div></strong></center><br/>
<center><strong>Core & Overall GPA Of <?=$_SESSION['sess_user'];?> are:- <div id = "result"><?php include "coregpa.php"; ?></div></strong></center>
</div>
<!-- <center><strong>Overall GPA Of <?=$_SESSION['sess_user'];?> is:- <div id = "result1"><?php //include "gpa.php"; ?></div></strong></center>-->

 <div class = "footer"> 
   <footer><!-- <a href="http://localhost/www21/index.php">Home</a><a href="http://localhost/www21/degree-plan.php">Degree Plan</a> |-->	 <a href="http://localhost/www21/degree-plan.php">Go Back</a> <!--| <a href="http://localhost/www21/courses.php">Courses</a>--> <br/><br/>
