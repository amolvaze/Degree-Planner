...
<?php 
 ...
 $sql = "select c.classname, g.gradeletter from class c JOIN user u JOIN grade g where c.classid = g.classid And u.userid = g.userid AND g.classid IN ('6301', '6313', '6360', '6363', '6375', '6322', '6359', '6384') AND u.username= '".$_SESSION['sess_user']."' ";      
...
if($array['classname'] == 'Big Data Management & Analytic' || $array['classname'] == 'Machine Learning' || $array['classname'] == 'Statistical Methods For Data Science' || $array['classname'] == 'Database Design' || $array['classname'] == 'Design and Analysis of Computer Algorithms')
					{
