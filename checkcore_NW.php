...
<?php
	     ...
	     //case "Data Science"
     $sql="select count(classid) AS core from class where classid IN ('6352', '6378', '6396', '6390', '6385')";
						...
						if ($result=mysqli_query($con,$sql))
						  ...
						  while ($array=mysqli_fetch_array($result))
							...
							print("You have completed Networks & Telecommunications core courses! ");
							 }
							 else {
