...
<div class = "main">
<h3 id = "text1"><a href="#">Register</a> | <a href="admin.php">Sign In</a></h3><br/><br/>
...
<input type="submit" value="Register" id = "Register_Button" name="submit_admin" />
</form>
</div>
...
//$query=mysqli_query($con, "SELECT * FROM user WHERE username='".$user."'" );
 $query=mysqli_query($con, "SELECT * FROM admin WHERE username='".$user."' OR name='".$name."'" );
...
{
$sql="INSERT INTO admin VALUES('','$name','$user','$pass','$degId')";
